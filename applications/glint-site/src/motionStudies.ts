export const motionStudies = [
  ...
  { name: "Connected desktop", hint: "Five windows float in and move between spaces. Resize nearby edges while they travel—each arrives at full size.", idea: "Varied adjoining windows, local shared resizing and ongoing vacancy moves. No sheen." },
] as const;
