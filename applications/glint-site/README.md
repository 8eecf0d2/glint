...
The intro begins white, brings in five broad grey app windows in four tones, using overlapping desktop positions with small random offsets and consistent landscape proportions, then reveals the canonical logo. The logo grows in sharply, catches moving specular light along beveled inner star edges, then rises into place after a pause. The stars breathe independently. The windows snap into place with uneven delays starting at 2.67 seconds; the settled composition holds for roughly a second before the logo rises at 4.45 seconds and content arrives at 5.1 seconds. The renderer cues the page reveal, with a fallback to keep content accessible if WebGL fails.
