...
The intro begins white, brings in five broad grey app windows in four tones, using overlapping desktop positions with small random offsets and consistent landscape proportions. The logo approaches from depth with perspective and a broad shadow, accelerates into contact at 1.54 seconds, and settles through one small compression. Its shadow tightens on impact as the windows snap quickly into place. After a settled hold, the logo drifts up at 3 seconds and content starts arriving at 3.48 seconds. [Paper’s Liquid Metal shader](https://shaders.paper.design/liquid-metal) catches the landing at 45% peak opacity, then continues at 16% opacity and a slower speed after the logo rises. There is no bounce or repeated scale pulse.
