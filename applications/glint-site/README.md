...
The download button has a single solid background colour. Its label and icon, and the headline, remain plain. A 140ms contrast accent accompanies the impact shake and returns to normal immediately afterward.
