...
The headline and download button use the same slow Liquid Metal treatment at 28% and 26% opacity. Responsive masks follow the headline’s rendered font and wrapping and the button’s rounded background; original text and button contents remain intact. A 140ms contrast accent accompanies the impact shake and returns to normal immediately afterward.
